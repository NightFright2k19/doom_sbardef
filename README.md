...
<ul>
  ...
  <li><b>Mugshot</b>: Animated face.<br>- HUDs: Classic Plus/Split, Nightdive I/III-V, Trinity I, Eternity I, DSDA II/III</li>
  <li><b>Ammo overview</b>: Amount of ammo available for each weapon.<br>- Current/total: Classic Plus/Split, Crispy Plus, Trinity I, DSDA I+II<br>- Current: Nightdive II-V, Doom 64 II, Trinity III+IV, Eternity, Boom II-IV, DSDA III<br>- Bars: Nightdive I</li>
  <li><b>Arms</b>: Available weapons.<br>- 1-7: DSDA III (8/9 if selected)<br>- 1-9: Classic Plus/Split, Crispy Plus, Nightdive II-IV, Eternity, Boom, DSDA I+II, PrBoom+</li>
  <li><b>Backpack</b>: Powerup which doubles ammo amount.<br>- Doubled totals: Classic Plus/Split, Crispy Plus, Trinity I, Eternity, Boom, DSDA I+II, PrBoom+<br>- Color: Nightdive II-V, Doom 64 II, Trinity, Eternity, Boom, DSDA, PrBoom+</li>
  <li><b>God mode</b>: Shows if player is invincible, either through powerup or cheat.<br>- Mugshot: Classic Plus/Split, Nightdive I/III-V, Trinity I, Eternity I, DSDA II+III<br>- Icon: Eternity II, PrBoom+ II<br>- Label: Crispy Plus, Nightdive II-V, Doom 64, Trinity III+IV, Boom, DSDA, PrBoom+ I<br>- Color: Nightdive IV+V, Doom 64 II, Trinity IV, Eternity, Boom, DSDA</li>
</ul>

**EXTRA Features (not provided by original HUD):**
<ul>
  <li><b>Armor type</b>: Level of damage absorption.<br>- Mugshot frame: Classic Plus/Split<br>- Icon: Nightdive I+II, Trinity I, Eternity II, PrBoom+<br>- Percentage: Crispy Plus, Nightdive III<br>- Bracket: Doom 64 I, Trinity III<br>- Color: Nightdive IV+V, Doom 64 II, Trinity IV, Eternity, Boom, DSDA</li>
  <li><b>Berserk</b>: Powerup which increases punching power with Fists.<br>- Icon: Nightdive I/II/V, Eternity II, PrBoom+<br>- Lit "1": Classic Plus/Split, Crispy Plus, Nightdive II-IV, Eternity, Boom, DSDA I+II, PrBoom+<br>- Red "N/A" Label: Eternity II, DSDA</li>
  <li><b>Chainsaw/Super Shotgun</b>: Whether secondary weapons for slots 1 or 3 are owned.<br>- 8/9: Classic Plus/Split, Crispy Plus, Nightdive II-IV, Eternity, Boom, DSDA I+II, PrBoom+<br>- Lit "1"/Fully lit "3": DSDA III</li>
  <li><b>Active ammo/weapon</b>: Currently selected weapon and fitting ammo.<br>- Full: Nightdive I-IV, Eternity, Boom IV, DSDA<br>- Ammo only: Nightdive V, Doom 64 II, Trinity III, Boom III<br>- Weapons only: Classic Split, Boom I, PrBoom+</li>
</ul>
...
| Classic Split | ++++++ | +++ | 9 / 10 | Core: All<br>Extras: No active Ammo |
...
| Boom I<br>PrBoom+ | ++++ | ++++ | 8 / 10 | Core: Vitals, Arms, Backpack, God<br>Extras: All |
| Nightdive V | +++++ | +++ | 8 / 10 | Core: No Arms<br>Extras: No Chainsaw/SSG |
| Nightdive I | ++++ | +++ | 7 / 10 | Core: Vitals, Mugshot, Ammo overview, God<br>Extras: No Chainsaw/SSG |
| Doom 64 II<br>Trinity IV | ++++ | ++ | 6 / 10 | Core: Vitals, Ammo overview, Backpack, God<br>Extras: Armor type, active ammo |
| Trinity I/II | +++++ | + | 6 / 10 | Core: No Arms<br>Extras: Armor type |
| Trinity III | ++++ | + | 5 / 10 | Core: Vitals, Ammo overview, Backpack, God<br>Extras: Armor type |
| Doom 64 I | ++ | + | 3 / 10 | Core: Vitals, God<br>Extras: Armor type |
<br>
...
![Screenshot](screenshots/04_nightdive-plus.png)
   **I. Plus**: Icons and STTNUM numbers in a single row. Bonus features: Ammo overview meters (four colorized bars in the bottom right corner) with Berserk indicator (Berserk pack icon shown in ammo area if fists are selected). Armor icon hidden unless some armor is owned.<br><br>
![Screenshot](screenshots/05_nightdive-stacked.png)
...
![Screenshot](screenshots/17_boom-comp.png)
   **I. Compact**: Everything grouped on the left side of the screen.<br><br>
![Screenshot](screenshots/18_boom-supply.png)
...
![Screenshot](screenshots/19a_boom-remix.png)
![Screenshot](screenshots/19b_boom-remix2.png)
...
![Screenshot](screenshots/20_boom-split.png)
...
![Screenshot](screenshots/24_prboom-standard.png)
...
<br><br>
![Screenshot](screenshots/25_prboom-balanced.png)
