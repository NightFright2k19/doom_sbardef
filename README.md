...
**5) ﻿Essentials**<br>
Sort of a minimized version of the following Boom variants, with focus on saving screen space.<br>
...
- <a href="https://github.com/NightFright2k19/doom_sbardef/blob/main/extras/ammo_names.pk3" target= "_blank">DSDA Ammo Names</a> (Names instead of slot numbers for ammo labels in DSDA)
...
- <a href="https://github.com/NightFright2k19/doom_sbardef/blob/main/extras/gradient_names.pk3" target= "_blank">Boom Font with Gradient Colors + DSDA Ammo Names</a> (Combines both addons)
<br>
